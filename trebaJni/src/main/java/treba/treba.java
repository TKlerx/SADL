...
public class treba implements trebaConstants {
	...
	public static hmm gibbs_counts_to_hmm(hmm hmm, SWIGTYPE_p_unsigned_int gibbs_sampled_counts_trans, SWIGTYPE_p_unsigned_int gibbs_sampled_counts_emit,
			SWIGTYPE_p_unsigned_int gibbs_counts_sampled_states, int alphabet_size, int num_states, double beta_t, double beta_e) {
	...
	public static wfsa gibbs_counts_to_wfsa(wfsa fsm, SWIGTYPE_p_unsigned_int gibbs_sampled_counts, SWIGTYPE_p_unsigned_int gibbs_counts_sampled_states,
			int alphabet_size, int num_states, double beta, double ANbeta) {
